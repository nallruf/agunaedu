...
export const DataCardMandiri = [
  {
    ...
    desccard: "Mempelajari HTML,CSS, dan Js",
    icon2: <LuBarChart />,
    icon3: <GoStarFill />,
    level: "Menengah",
    rating: "4.9 (2k)",
  ...
  },
  {
    ...
    desccard: "Mempelajari advanced JS concepts",
    icon2: <LuBarChart />,
    icon3: <GoStarFill />,
    level: "Level Tinggi",
    rating: "4.9 (2k)",
  ...
  },
  {
    ...
    icon1: <FaLaptop />,
    tes: ["Front End Web Development"],
    titlecard: "Build Mobile Apps with JavaScript",
    desccard: "Mempelajari react native",
    icon2: <LuBarChart />,
    icon3: <GoStarFill />,
    level: "Level Tinggi",
    rating: "4.9 (2k)",
  ...
  },
  {
    ...
    desccard: "Mempelajari Advanced Web Performance",
    icon2: <LuBarChart />,
    icon3: <GoStarFill />,
    level: "Level Tinggi",
    rating: "4.9 (2k)",
  ...
  },
  {
    ...
    desccard: "Mempelajari Mern Stack",
    icon2: <LuBarChart />,
    icon3: <GoStarFill />,
    level: "Level Tinggi",
    rating: "4.9 (2k)",
