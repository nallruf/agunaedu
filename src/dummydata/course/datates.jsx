export const dataTesHacker = [
  {
    ...
    description:
      "Tes ini akan membantu kamu untuk lebih memahami tentang apa itu role hacker dan akan memabntu ke kelas lanjutan di path role hacker ini",
    about:
...
export const dataTesHustler = [
  {
    ...
    about:
      "Tes ini berisikan soalan teori dan soalan praktek. Mentee diharuskan untuk mencapai skor 80 agar dapat lulus tes ini dan dapat membuka kelas lanjutan di role huslter",
