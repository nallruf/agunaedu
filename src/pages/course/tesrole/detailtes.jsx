                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <h3 className="flex items-center gap-2">
                      ...
                      <span className="text-iconInput text-sm">
                        {classItem.time < 60
                          ? `${classItem.testDuration} Menit`
                          : `${Math.floor(classItem.testDuration / 60)} Jam ${
                              classItem.testDuration % 60 !== 0
                                ? (classItem.testDuration % 60) + " Menit"
                                : ""
                            }`}
                      </span>
                    </h3>
